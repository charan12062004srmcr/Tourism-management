...
void india()
{
	...
	printf("\t\t\t\t1. Simla Tour Packages 6 Days 7 Nights (1010/-)\n");
	printf("\t\t\t\t2. Kashmir Tour Packages 5 Days 4 Nights (2020/-)\n");
	printf("\t\t\t\t3. Kolkata Tour Packages 11 Days 10 Nights (3030/-)\n");
	printf("\t\t\t\tEnter Choice: ");
	scanf("%d", &a);
	if (a == 1) {
...
void inter()
{
	...
	printf("\t\t\t\t1. England Tour Packages 6 Days 7 Nights (4040/-)\n");
	printf("\t\t\t\t2. Thailand Tour Packages 5 Days 4 Nights (5050/-)\n");
	printf("\t\t\t\t3. New York Tour Packages 11 Days 10 Nights (6060/-)\n");
	printf("\t\t\t\tEnter Choice: ");
	scanf("%d", &a);
	if (a == 1) {
